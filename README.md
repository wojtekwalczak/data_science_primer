...
* \[[mooc](https://www.youtube.com/playlist?list=PLZHQObOWTQDMsr9K-rj53DwVRMYO3t5Yr)\] **_Essence of calculus_ by Grant Sanderson** - The best short series of videos for building basic intuitions behind core concepts of calculus. Beautifully visualized and explained. Definitely, the number one source for anyone starting with calculus, although I believe calculus practicioners can also benefit from it. NOTE: This description is analogous to Grant Sanderson's series of linear algebra videos, mentioned below. Both are equally worth viewing.
